...
if __name__ == "__main__":
    ...
    # 이제 repo_documents 변수에서 각 파일의 내용과 메타데이터에 접근할 수 있습니다
    # 예시:
    ...
    # 확인용으로 변수 내용 출력
    print("==================page_content=================")
    print(repo_documents[0].page_content)
    print("===============================================")
    print("==================metadata=================")
    print(repo_documents[0].metadata)
    print("===============================================")
    print("==================file_name=================")
    print(repo_documents[0].metadata['file_name'])
    print("===============================================")
    print("==================file_path=================")
    print(repo_documents[0].metadata['file_path'])
    print("===============================================")
