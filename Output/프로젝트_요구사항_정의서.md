...
![Project Status](https://img.shields.io/badge/Status-개발중-yellow)
...
| 컴포넌트 | 기술 스택 | 역할 | 상태 |
|---------|----------|------|------|
| 🐍 **Flask 웹앱** | Python 3.9+ | 메인 애플리케이션 | ✅ 구현완료 |
| 🗄️ **MySQL DB** | GCP Cloud SQL | 사용자/세션/채팅 기록 | ✅ 구현완료 |
| 📊 **ChromaDB** | Vector Database | 코드 임베딩 저장 | ✅ 구현완료 |
| 🤖 **OpenAI API** | GPT-4 | AI 답변 생성 | ✅ 연동완료 |
| 🐙 **GitHub API** | REST API | 저장소 데이터 조회 | ✅ 연동완료 |
| 🔐 **OAuth** | GitHub/Google | 소셜 로그인 | ✅ 구현완료 |
...
| 카테고리 | 기능 수 | 완성도 | 우선순위 |
|---------|--------|--------|---------|
| 🔐 **인증 시스템** | 3개 | ![100%](https://progress-bar.dev/100) | 🔴 High |
| 🔍 **저장소 분석** | 4개 | ![100%](https://progress-bar.dev/100) | 🔴 High |
| 💬 **채팅 시스템** | 5개 | ![100%](https://progress-bar.dev/100) | 🔴 High |
| 📋 **세션 관리** | 6개 | ![100%](https://progress-bar.dev/100) | 🟡 Medium |
| 🔧 **코드 수정** | 4개 | ![100%](https://progress-bar.dev/100) | 🟡 Medium |
| 📁 **파일 관리** | 3개 | ![100%](https://progress-bar.dev/100) | 🟢 Low |
